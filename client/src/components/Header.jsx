    ...
    <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20">
      ...
      <div >
        <h1 className="text-4xl xl:text-5xl 2xl:text-6xl font-bold text-neutral-700 leading-tight">
          Remove the <br className="max-md:hidden" /> <span className="bg-linear-to-r from-violet-600 to-fuchsia-500 bg-clip-text text-transparent">background from</span> <br className="max-md:hidden"/> image for free.
        </h1>
        <p className="my-6 text-[15px] text-gray-500">
          Upload your image and let our AI do the rest! <br className="max-sm:hidden"/> Upload your image
